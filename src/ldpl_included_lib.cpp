void add_ldpllib(compiler_state & state){
    ...
    state.add_var_code("#define ldpl_number double");
    state.add_var_code("");
    ...
    state.add_var_code("}");
    state.add_var_code("");
    state.add_var_code("ldpl_number to_number(const string & a){");
    state.add_var_code("    try {");
    state.add_var_code("        ldpl_number num = stod(a);");
    state.add_var_code("        return num;");
    state.add_var_code("    }");
    state.add_var_code("    catch (const std::invalid_argument& ia) {");
    state.add_var_code("		return 0;");
    state.add_var_code("    }");
    state.add_var_code("}");
    state.add_var_code("");
    state.add_var_code("");
    ...
    state.add_var_code("}");
    state.add_var_code("");
    state.add_var_code("ldpl_number str_len(const string & a){");
    state.add_var_code("    return utf8_strlen(a);");
    state.add_var_code("}");
    state.add_var_code("");
    state.add_var_code("ldpl_number get_char_num(const string & chr){");
    state.add_var_code("    if (chr.size() != 1) {");
    state.add_var_code("            cerr << \"Runtime Error: GET CHAR AT expects a string of length 1, got: \";");
    ...
    state.add_var_code("}");
    state.add_var_code("");
    state.add_var_code("string charat(const string & s, ldpl_number pos){");
    ...
    state.add_var_code("}");
    state.add_var_code("");
    state.add_var_code("#include <random>");
    state.add_var_code("");
    state.add_var_code("ldpl_number get_random(){");
    state.add_var_code("	ldpl_number r = rand() * NVM_FLOAT_EPSILON;");
    state.add_var_code("    r = r - (int) r;");
    state.add_var_code("	return r;");
    state.add_var_code("}");
}
