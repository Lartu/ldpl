<p align="center">
  ...
  <a href='https://www.freelists.org/list/ldpl'><img src="https://img.shields.io/badge/mailing_list-ldpl-lightgray.svg"></a>
...
way possible.
- [**The LDPL Ncurses Library**](https://github.com/Lartu/ldpl-ncurses): a ncurses wrapper for LDPL designed for creating terminal applications that require more complex text user-interfaces than simple line-feeding.
- [**The LDPL Network Server Library**](https://github.com/Lartu/ldpl-net-server/): the LDPL Network Server Library is a library for creating socket based servers in LDPL. It aims to make it very easy to develop, test and deploy network servers, with as little work as possible.
...
You can use any other editor (without syntax highlighting) if you like. If you know how to write syntax packages for other editors and would like to contribute to the LDPL project, a highlighting extension would be a very welcome contribution.
...
The LDPL Programming Language is a non-profit project maintained by people like you from all over the world. If you like what we do, please consider [donating](https://www.ldpl-lang.org/support.html) to the LDPL project.
...
The LDPL Compiler is distributed under the Apache 2.0 License. All LDPL Dinosaur logos were created by [Lartu](https://github.com/Lartu) and are released under a Creative Commons Attribution 4.0 International (CC BY 4.0) license.
